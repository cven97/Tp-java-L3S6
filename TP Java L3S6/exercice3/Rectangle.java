...
public class Rectangle {
	...
	public Boolean contains(Rectangle R){
		...
		if(this.contains(R.getPointBase())){
			...
			float x = R.getDimensionH1() + R.getPointBase().getX() - this.getPointBase().getX();
			float y = R.getDimensionV1() + R.getPointBase().getY() - this.getPointBase().getY();
			
			if(this.getDimensionH1() >= x && this.getDimensionV1() >= y)
				val = true;
		}
