...
public class SlantedRectangle extends Rectangle {
	...
	public Boolean equals(SlantedRectangle R){ // Redefinission de la methode equals
		if(super.equals((Rectangle)R) && this.getAngle() == R.getAngle())
			return true;
		else
			return false;
	}
	
	public Boolean rotate(float angle){ // rotation du rectangle
		
		this.setAngle( this.getAngle() + angle );
		return true;
	}
	
	public Boolean translate(Point V){ // trnaslation du rectangle
