...
public class Rectangle {
	...
	public Boolean equals(Rectangle R){ // Redefinission de la methode equals
		if(this.getPointBase().equals(R.getPointBase()) && this.getDimensionH1() == R.getDimensionH1() && this.getDimensionV1() == R.getDimensionV1())
			return true;
		else
			return false;
	}
	
	public String toString(){ // Definition de la methode toString 
	...
	public float calculSurface(){
		return this.dimensionH1*this.dimensionV1;
	}
